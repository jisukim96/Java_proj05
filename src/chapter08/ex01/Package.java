...
//다른 패키지에 존재하는 클래스는 import가 필요함
import chapter08.ex02.Student;
import chapter07.*; 			//주의 : 하위 패키지는 적용 안됨. 클래스만 적용됨
	...
	public static void main(String[] args) {
		/* 클래스 내부 구성요소 :
		   ...
		   클래스 외부 구성요소
			...
			1. 패키지(package) : 클래스를 조직화해서 관리하는 하나의 폴더
				 한 패키지 내의 동일한 이름의 클래스는 올 수 없다.
				 외부에서 클래스를 가지고 오는 경우 기존의 클래스 이름과 동일한 경우
			2. 임포트 (import) : 다른 패키지의 클래스를 사용하고자 하는 경우
		...
		*/
		...
		//car 클래스는 import 없이 전체 이름(패키지 이름, 클래스이름)으로 사용
