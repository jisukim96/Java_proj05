...
class Bb{	//this()를 사용하여 생성자 작성
	// 필드 선언
	int m1,m2,m3,m4;
	
	Bb(){		// 기본 생성자 : 변수에 초기값 할당
		m1 = 1;
		m2 = 2;
		m3 = 3;
		m4 = 4;
...
public class This_Method02 {
	...
	public static void main(String[] args) {
		// this() : 생성자 내부에서 사용이 되고 , 첫 라인에 위치해야하고 , 자신의 객체의 다른 생성자 호출
				// 생성자를 여러 개 생성할 때 코드를 줄여줄 수 있다.
		...
		// this() 를 사용해서 생성자 호출
		// 기본 생성자 호출
		System.out.println("======== Bb 클래스의 기본생성자 호출 ==========");
		Bb b1 = new Bb();
		b1.print();	
