...
public class TypeCasting01 {
	...
	public static void main(String[] args) {
		...
		Tiger t2 = (Tiger) a1;		
		// t2는 Animal과 Tiger 의 필드와 메소드를 모두 접근 가능.
		...
		// Tiger 타입으로 객체생성 : Animal , Tiger 의 필드와 메소드 모두 접근
		// t3 : Animal , Tiger 모두 내포
		Tiger t3 = new Tiger();
		
		//다운캐스팅 : 실행 시 오류 발생, t3는 TigerChild를 내포하지않기 때문에 다운 캐스팅 실행 시 오류발생
		...
		//다운캐스팅할 때는 반드시 instanceof 를 확인해야한다. 
		...
		// 1. 업캐스팅  a3 : Animal,Tiger,TigarChild
		...
		t6.tigerChildCound = "어흥";	//TigerChild
		System.out.println(t6.age);
		System.out.println();
		
		// t6 (TigerChild)---> Animal 업캐스팅
