...
public class String_Object_01 {
	...
	public static void main(String[] args) {
		// 참조 자료형 : 객체 ( String ) 
		/*
		  String 문자열을 저장하는 자바에서 생성해놓은 객체 ( 첫글자 대문자로 시작)
		  	- 다른 객체와는 다른 특수한 기능들이 들어있음.
		  	
		 */
		
		// 1. String 으로 객체 생성방법 1		<== 별도의 주소에 생성됨. 값을 수정할 수 없다.
		String str1 = new String ("안녕");		// 생성자를 사용해서 값을 넣는 방법
		System.out.println(str1);
		
		// 2. String 으로 객체 생성 방법 2	<== 다른 객체와 공유
		String str2 = "안녕하세요";					// 리터럴(변수에 들어가는 값) 형식으로 값을 넣는 방법
		System.out.println(str2);
		
		System.out.println("=======================");
		
		// 3. 문자열 수정 ( 객체 내의 내용 변경 불가 ===> 새로운 객체가 생성 )
