...
public class Array_Input_Output {
	...
	public static void main(String[] args) {
		...
		System.out.println("=====for 문을 사용해서 대량으로 값을 넣고 출력=====");
		// arr2에 방을 100개 선언 , for문을 사용해서 각 방에 1부터 시작해서 1씩 증가
		int[] arr2 = new int[100];
		
		// for문을 사용해서 값 할당하기 : i = index(방번호)
		...
		// Enhanced For : 배열의 각 방의 값을 출력할 때 쉽게 출력할 수 있다.
		// 		- 0 ~ 마지막 방까지 한꺼번에 출력
		...
		System.out.println(arr1.length); //방개수 : 5개
		System.out.println(arr2.length); //방개수 : 100개
		System.out.println(arr3.length); //방개수 : 100개
